...
class ExchangeManager:
    """Exchange manager ultra-leve 100%% async usando aiohttp."""
    ...
    async def get_balance(self) -> Dict:
        """Retorna saldo USDT da conta UNIFICADA, iterando todos os coins."""
            ...
            for acc in accounts:
                ...
                for coin in coins:
                    if coin.get('coin') == 'USDT':
                        # Usa walletBalance como principal, equity como fallback
                        ...
                        return {
                            'USDT': {
                                'total': wallet if wallet > 0 else equity,
                                'equity': equity,
                                'available': available,
                            }
                        }
