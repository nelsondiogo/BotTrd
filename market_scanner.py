...
class MarketScanner:
    def __init__(self, exchange_manager, settings: Dict[str, Any]):
        ...
        self.signal_gen = SignalGenerator(adx_threshold=20.0)  # Reduzido de 25
    ...
    async def scan(self, balance: float, top_n: int = 7, timeframe: str = '15') -> Dict[str, Any]:
        ...
        for c in candidates:
            ...
            if len(ohlcv_m15) < 30 or len(ohlcv_h1) < 20: continue
            try:
    ...
    async def _filter_candidates(self, tickers: Dict, balance: float) -> List[Dict]:
        ...
        for symbol, ticker in tickers.items():
            ...
            # Volume mínimo muito baixo para permitir saldos pequenos
        ...
        self._candidates_cache = candidates[:40]  # Top 40
